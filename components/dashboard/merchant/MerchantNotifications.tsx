...
import { Bell, Filter, CheckCircle2, AlertTriangle, DollarSign, Package } from 'lucide-react';
...
export const MerchantNotifications: React.FC = () => {
  ...
  const filteredNotifs = notifications.filter(n => {
      ...
      if (filter === 'alerts') return n.type === 'dispute' || n.type === 'payment';
      return true;
  });
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <div className="flex justify-between items-start mb-1">
                                    ...
                                    <span className="text-[10px] text-white/30 font-mono whitespace-nowrap">{notif.date}</span>
                                </div>
                                <p className="text-xs text-white/40 line-clamp-1">
                                    Click to view details regarding Order #{notif.orderId}
                                </p>
                            </div>
                            {!notif.isRead && (
