                        ...
                        <tbody className="divide-y divide-white/5">
                            {transactions.map((tx) => (
                                <tr key={tx.id} className="hover:bg-white/5 transition-colors group">
                                    ...
                                    <td className="p-4">
                                        <span className={`inline-flex items-center gap-1.5 px-2 py-1 rounded text-xs font-bold border ${tx.type === 'sale' ? 'bg-green-500/10 text-green-400 border-green-500/20' :
                                    ...
                                    <td className="p-4">
                                        <span className={`text-xs ${tx.status === 'completed' ? 'text-green-500' :
