...
export const SecurityAudit: React.FC = () => {
    const { t } = useLanguage();
    const [activeTab, setActiveTab] = useState<'overview' | 'audit' | 'config' | 'recoveries'>('overview');
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex bg-white/5 rounded-lg p-1 border border-white/10">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-md text-xs font-bold transition-all ${activeTab === 'recoveries' ? 'bg-orange-500 text-white' : 'text-white/50 hover:text-white'}`}
                    >
                        Account Recoveries
                    </button>
                </div>
